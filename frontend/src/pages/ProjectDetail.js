                      ...
                      {project.keywords.map((keyword, index) => {
                        ...
                        return (
                          <tr key={index}>
                            ...
                            <td className={rankingData.ranking ? 'ranking-value' : ''} style={rankingData.ranking === null ? {color:'#000'} : rankingData.ranking > rankingData.previousRanking ? {color:'#f44336'}:{color:'#4caf50'}}>
